        ...
        <main className="min-h-screen relative">
            ...
            <div className="flex flex-row gap-5 mx-20 mb-5">
                ...
                <div className="flex-1 flex flex-col gap-5">
                    ...
                    {/* Vector Golf */}
                    <div className="relative p-7 pb-0 bg-black rounded-2xl">
                        <div className="p-5 bg-white">
                            <img src="/assets/vectorgolf.png" alt="Vector Golf" width={50} />
                            ...
                            The game is still in development, but it works both on mobile and desktop.
